...
class Mix_ST_GATE(torch.nn.Module):
    ...
    def forward(self, features, features_a, adj1, adj2, graph_neigh1, graph_neigh2):
        hiden_emb1, h1, ret1, ret_a1, emb1, emb_a1 = self.ST_GATE(features, features_a, adj1, graph_neigh1)
        hiden_emb2, h2, ret2, ret_a2, emb2, emb_a2 = self.ST_GATE(features, features_a, adj2, graph_neigh2)
